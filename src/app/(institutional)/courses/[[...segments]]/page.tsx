...
export function generateMetadata(): Promise<Metadata> {
  return getInstitutionalAcademicMetadata(AcademicResource.COURSE);
}

export default function CoursesPage(props: InstitutionalAcademicPageProps): Promise<React.ReactElement> {
  return renderInstitutionalAcademicRoute(AcademicResource.COURSE, props);
}
