# React performance reference index

Read only the rule needed for the reported problem. [SKILL.md](SKILL.md) defines the repository-specific boundaries. Individual rule files are the source of truth; this index does not duplicate their guidance.
...
- [Match Pending State to the Operation Owner](rules/rendering-usetransition-loading.md)
...
- [Read Latest Values from Effect Events](rules/advanced-use-latest.md)
